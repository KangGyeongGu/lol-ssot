...
usage() {
  cat <<'USAGE'
Usage:
  AGENTS/CODEX/scripts/run_all_validators.sh [options]
...
run_llm_remediation() {
  ...
  rem_spec="AGENTS/CODEX/REMEDIATION_SYNTHESIZER.md"
  rem_raw_rel="AGENTS/CODEX/WORK_LOGS/${RUN_ID}/REMEDIATION_PLAN.raw.md"
...
for idx in "${!AGENT_KEYS[@]}"; do
  KEY="${AGENT_KEYS[$idx]}"
  SPEC_FILE="AGENTS/CODEX/${KEY}.md"
  RAW_FILE="AGENTS/CODEX/WORK_LOGS/${RUN_ID}/${KEY}.raw.md"
  OUT_FILE="AGENTS/CODEX/WORK_LOGS/${RUN_ID}/${KEY}.md"
