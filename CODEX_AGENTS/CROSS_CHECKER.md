---
name: cross-checker
description: 01_PRODUCT, 02_DESIGN, 03_API, 03_DOMAIN 간 용어/흐름/링크 불일치만 교차 검증한다.
---
...
- 디자인 구조와 제품 페이지 모델 충돌 여부
- 문서 링크가 필요한 범위로만 연결되어 있는지 여부

## 출력
- [[CODEX_AGENTS/INDEX.md]]의 공통 PASS/FAIL 포맷을 사용한다.
- 보고서 파일: [[CODEX_AGENTS/WORK_LOGS/README.md]] 하위 RUN_ID/CROSS_CHECKER.md
